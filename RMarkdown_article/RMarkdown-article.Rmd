...
```{R, echo=FALSE, message=FALSE, warning=FALSE, fig.width=3, fig.height=3, fig.align='center',fig.cap="Figure 1. Richesse spécifique en fonction de la température de l'eau."}

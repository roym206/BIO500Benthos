...
{\centering \includegraphics{RMarkdown-article_files/figure-latex/unnamed-chunk-1-1} 

}

\caption{Richesse spécifique en fonction de la température de l'eau.}\label{fig:unnamed-chunk-1}
\end{figure}
...
{\centering \includegraphics{RMarkdown-article_files/figure-latex/unnamed-chunk-2-1} 

}

\caption{Richesse spécifique en fonction de la vitesse du courant.}\label{fig:unnamed-chunk-2}
\end{figure}
...
lorsqu'il y a entre 0,4 et 0,6m de profondeur. Le
...
{\centering \includegraphics{RMarkdown-article_files/figure-latex/unnamed-chunk-3-1} 

}

\caption{Richesse spécifique en fonction de la profondeur.}\label{fig:unnamed-chunk-3}
\end{figure}

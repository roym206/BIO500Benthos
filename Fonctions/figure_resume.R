...
digraph {
  ...
  title [label = <<B>Facteurs impactant la richesse spécifique du benthos<B>>, shape = plaintext, fontsize = 20, fontcolor = black]
...
digraph {
  ...
  # Ajouter un nœud pour le titre principal en gras
  title [label = <<B>Facteurs impactant la richesse spécifique du benthos</B>>, shape = plaintext, fontsize = 20, fontcolor = black]
...
digraph {
  ...
  # Ajouter un nœud pour le titre principal sur deux lignes
  title [label = <<B>Facteurs impactant la richesse<BR/>spécifique du benthos</B>>, shape = plaintext, fontsize = 20, fontcolor = black]
...
digraph {
  ...
  # Nœud fictif pour ajouter un espace entre le titre et la légende
  spacer [label = \"\", shape = plaintext, width = 0, height = 0, style = invis]
  ...
  # Relier le titre au nœud fictif spacer pour créer de l'espace
  title -> spacer [style = invis]
  spacer -> invisible_anchor [style = invis]
...
digraph {
  ...
  # Nœud fictif pour ajouter un espace entre le titre et la légende
  space_between_title_and_legend [label = \"\", shape = plaintext, width = 0, height = 0, style = invis]
  ...
  # Relier le titre au nœud fictif pour créer un espace
  title -> space_between_title_and_legend [style = invis]

  # Relier le nœud fictif à la légende
  space_between_title_and_legend -> cluster_legend [style = invis]
